  ...
  <div class="w-layout-blockcontainer container w-container">
    <div class="about-inner-hero-grid">
      ...
      <div class="about-inner-hero-visual fade-in">
        <img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=800&q=80" loading="lazy" alt="Subsidy advisory consultation" class="about-inner-hero-img"/>
      </div>
    </div>
  </div>
</section>
